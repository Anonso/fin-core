...
- 状态：修复完成；复验半闭环（2026-09-04）：CC 腿 PASS，codex 腿待 finqa-x 恢复
  补发探针或下次实弹同题验证（09-05 午后健康检查仍 429×2，request id
  a360a3993c556387-LAX，台账同目录 healthcheck-20260905.md）。新条款两腿即时
  生效（AGENTS.md symlink 同源）。

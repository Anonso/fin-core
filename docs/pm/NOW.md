...
| 旁路·施工 | 36 | A/B 复核立案：S-0904B 退役不 durable——09-04 已备份+裁决退役，09-05 08:47 被 backfill 复活（.md+索引条目双残留，09-08 已按原裁决补删+清索引，备份 article-prune-backup-20260904T222303 逐字节一致）；根因=退役无墓碑闸，capture 侧重导入可再复活；修复=墓碑机制设计（manage-zsxq-article-retirement 域） | owner 拍板墓碑方案 |

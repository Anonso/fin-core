...
| 旁路·owner | 31 | 回放证据层扩篮子拍板：老登组现=中证银行单代码（首批扫批 09-06 已落回放线正文：1 supports/5 open 滚动值，方向类窗口暂钉 9/30 待改判，机验 PASS，备份 g-cognition-mainline.20260906-pre-replay-batch1） | owner 下次验证批次或随用拍板 |

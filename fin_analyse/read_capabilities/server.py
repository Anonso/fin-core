...
_TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "read_instrument_scores": (
        ...
        "articles with energy score >= 6.0 are indexed (full local-index backfill "
        "2026-09-03; incremental captures use the same >=6.0 gate); energy <6 rows "
        "are NOT in this registry even though full-text search still sees the "
        "articles. Records return newest first by publish time: the newest row is "
